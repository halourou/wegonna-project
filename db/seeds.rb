...
Task.create({name: "Assigned To Halourou 1 - today", priority: 1, creator_id: users[0].id,
  assignee_id: users[0].id, project_id: shared_projects[0].id})
Task.create({name: "Assigned To Halourou 1 - upcoming", priority: 2, creator_id: users[0].id,
  assignee_id: users[0].id, project_id: shared_projects[0].id})
Task.create({name: "Assigned To Halourou 1 - later", priority: 3, creator_id: users[0].id,
  assignee_id: users[0].id, project_id: shared_projects[0].id})
Task.create({name: "Assigned To Halourou 1 - no priority", creator_id: users[0].id,
  assignee_id: users[0].id, project_id: shared_projects[0].id})
Task.create({name: "Halourou 1 created - assigned to NOT-ME", creator_id: users[0].id,
  assignee_id: users[1].id, project_id: shared_projects[0].id})
Task.create({name: "Halourou 1 created - unassigned", creator_id: users[0].id,
  project_id: shared_projects[0].id})
Task.create({name: "Assigned To Halourou 1 - completed", completed: true, creator_id: users[0].id,
  assignee_id: users[0].id, project_id: shared_projects[0].id})

Task.create({name: "Assigned To Halourou 2", creator_id: users[0].id,
  assignee_id: users[0].id, project_id: shared_projects[1].id})
Task.create({name: "Halourou 2 created - assigned to NOT ME", creator_id: users[0].id,
  assignee_id: users[1].id, project_id: shared_projects[1].id})

Task.create({name: "Halourou assigned - no project", creator_id: users[0].id,
